...
اختر دائماً منتجات معتمدة من هذه المعايير.`,
  ...
  {
    id: 5,
    title: "مشروع مصنع أدوية: دليل شامل للتأسيس والنجاح",
    excerpt: "تعرف على الخطوات الأساسية، التكاليف، والمتطلبات لإنشاء مصنع أدوية متطور في المنطقة العربية.",
    content: `مشروع مصنع أدوية في السياق العربي هو منشأة صناعية إستراتيجية تهدف إلى إنتاج مستحضرات دوائية آمنة، فعالة، وعالية الجودة وفق أعلى المعايير العالمية.

**كيفية إنشاء مصنع أدوية:**
1. **تحديد الرؤية والاستراتيجية**: اختيار الدولة المستهدفة ونطاق المنتجات.
2. **إعداد دراسة الجدوى**: تحليل السوق المحلي والإقليمي والجوانب الفنية والمالية.
3. **التأسيس القانوني**: تسجيل الشركة والحصول على السجل التجاري.
4. **الموافقات والتراخيص**: التقدم للهيئات التنظيمية (مثل SFDA أو EDA).
5. **التصميم والإنشاء**: الالتزام بشروط GMP العالمية وأنظمة HVAC.
6. **تجهيز المصنع**: شراء خطوط الإنتاج وأجهزة المختبرات.

**التكاليف المتوقعة:**
تتراوح التكلفة الاستثمارية لمصنع أدوية تقليدية متوسط الحجم بين 5 إلى 15 مليون دولار، بينما قد تتجاوز 50 مليون دولار للمصانع البيولوجية.

**أهمية الجودة (GMP):**
يرتكز نجاح المشروع على الالتزام بمعايير ممارسات التصنيع الجيد (GMP)، والتي تضمن سلامة المنتج وفعاليته من خلال التحكم الصارم في البيئة، التوثيق الكامل، وكفاءة الكوادر البشرية.`,
    author: "فريق السراج",
    date: "2024-04-15",
    category: "مشاريع",
    image: "💊",
            ...
            <div className="space-y-8">
              ...
              <Card className="p-6 border-border">
                ...
                <div className="space-y-2">
                  {["تقنية", "صيانة", "معايير", "أخبار", "مشاريع"].map((cat) => (
                    <button
                      key={cat}
